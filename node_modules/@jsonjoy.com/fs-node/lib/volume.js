...
class Volume {
    ...
    cpSymlinkSync(destStat, src, dest, options) {
        ...
        if (!options.verbatimSymlinks && !(0, path_1.isAbsolute)(linkTarget))
            linkTarget = resolveCrossPlatform((0, fs_node_utils_2.pathDirname)(src), linkTarget);
        if (destStat)
            this.unlinkSync(dest);
