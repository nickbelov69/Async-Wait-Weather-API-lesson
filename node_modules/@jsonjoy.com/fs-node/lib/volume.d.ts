...
import { type IReadOptions, type IReadParams, type IWriteOptions, type ReadCallback } from './readWriteArgs';
...
export declare class Volume implements FsCallbackApi, FsSynchronousApi {
    ...
    readSync: {
        (fd: number, buffer: Buffer | ArrayBufferView | DataView, offset?: number | null, length?: number | null, position?: number | bigint | null): number;
    ...
    read: {
        ...
        (fd: number, buffer: Buffer | ArrayBufferView | DataView, options: IReadOptions | null, callback: ReadCallback): void;
        (fd: number, buffer: Buffer | ArrayBufferView | DataView, offset: number | null, length: number | null, position: number | bigint | null, callback: ReadCallback): void;
    };
    readv: {
    ...
    private _write;
    writeSync: {
        (fd: number, buffer: Buffer | ArrayBufferView | DataView, offset?: number | null, length?: number | null, position?: number | null): number;
    ...
    write: {
        ...
        (fd: number, buffer: Buffer | ArrayBufferView | DataView, options: IWriteOptions | null, callback: (...args: any[]) => void): any;
    };
    private writevBase;
    writev: {
