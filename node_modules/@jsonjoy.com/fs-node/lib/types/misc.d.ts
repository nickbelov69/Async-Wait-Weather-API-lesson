...
export interface IFileHandle extends EventEmitter {
    ...
    write<T extends ArrayBufferView>(buffer: T, offset?: number | null, length?: number | null, position?: number | null): Promise<TFileHandleWriteResult<T>>;
    write<T extends ArrayBufferView>(buffer: T, options?: {
        offset?: number | null;
        length?: number | null;
        position?: number | null;
    } | null): Promise<TFileHandleWriteResult<T>>;
    write(data: string, position?: number | null, encoding?: BufferEncoding | null): Promise<TFileHandleWriteResult<string>>;
